  ...
  return (
    ...
    <h1 className="flex items-center justify-center text-white text-center px-5 text-3xl h-screen font-bold uppercase"> Loading...</h1>
     ...
     <section className="p-8 max-w-7xl mx-auto">
      ...
      <h1 className="flex items-center justify-center text-white text-center px-5 text-3xl font-bold lg:text-5xl"> Petfinder</h1>
     <p className='m-8 text-white'>This application is powered by <a href="https://thedogapi.com" className="text-indigo-600 underline active:text-orange-400"> The Dog Api</a> </p>
       ...
       {!searched ? dogs.map((dog) =>(
        ...
        {dogs.map((dog) =>(
            ...
            <img 
                ...
                alt={dog.name}
                className='rounded md:h-72 w-full object-cover'></img>
